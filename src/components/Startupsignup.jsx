...
function Startupsignup() {
  ...
  { bringTheLoadingPage ? (
    <LoadingPage text={"submitting your data..."}/>
      ...
      <div className='  mt-36 md:w-[90%] h-[580px] mx-auto flex relative'>
          <div className="w-[30%] h-[580px] bg-black sm:fixed ">
            {/* The blurred image */}
            <img 
              src={startuppic} 
          ...
          <div className='md:w-[68%] w-[330px] bg-white absolute right-0 top-0 pb-10'>
